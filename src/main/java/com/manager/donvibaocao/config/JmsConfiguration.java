package com.manager.donvibaocao.config;
...
public class JmsConfiguration {
    ...
    @Bean
    public ConnectionFactory connectionFactory(@Value("${spring.activemq.user:admin}") String username,
                                               @Value("${spring.activemq.password:password}") String password,
                                               @Value("${spring.activemq.broker-url:tcp://vtools.xyz:61616}") String brokerUrl) {
